...
\begin{document}
%-----------  填写以下基本信息 -----------------------------
\def\theTitle{论文题目}             %-- 论文标题 --
\def\theEngTitle{English Title} %-- 论文英文标题 --
\def\theMajor{数学与应用数学(师范)专业}      %-- 专业 --
\def\theEnMajor{Mathematics and Applied Mathematics}  %-- 专业的英语翻译 --
%--数学与应用数学 Mathematics and Applied Mathematics
%--数学与应用数学（师范类） Mathematics and Applied Mathematics (Normal Education）
%--数学与应用数学（公费师范生）Mathematics and Applied Mathematics (State-financed Normal Education）
%--信息与计算科学 Information and Computation Science
\def\theInstitution{数学科学学院}    %-- 院系 --
\def\theNo{2015100013}  %-- 学号 --
\def\theAuthor{张三}   %-- 作者姓名 --
\def\theEnName{Zhang San}  %-- 作者姓名拼音
\def\theTutor{李四}    %-- 指导教师姓名 --
\def\theEnTutor{Li Si}  %-- 指导教师姓名拼音 ---
\def\theProTitle{讲师}  %--- 指导教师职称 --

\def\theDate{2019年5月15日} %--- 论文定稿时间 ---
%-----------------------------------------------------------

\include{cover/cover}   %-- 导入封面 --
